...
async function create(req, res) {
  ...
  // req.body.cast = req.body.cast.trim(); <here previously when embedding 
  // split cast into an array if it's not an empty string - using a regular expression as a separator
  // if (req.body.cast) req.body.cast = req.body.cast.split(/\s*,\s*/); <- here previously when using embedding
